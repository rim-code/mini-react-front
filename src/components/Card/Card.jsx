...
const Card = ({ item, passedFunction }) => {

    const navigate = useNavigate()   //pour navigate  version 6 page a une autre usehisotry version 5.2.0
            ...
            <div className="card" style={{ width: '18rem' }}>
                ...
                <div className="card-body">
                    ...
                    <ul className="infoUser">
                        ...
                        <li>Street:<span> {item.street}</span></li>
                    </ul>

                </div>

                <div className="Icon">
                    <i onClick={passedFunction} className=" deleteIcon far fa-trash-alt"></i><i onClick={() => navigate(`/update/${item._id}`)} className="editIcon fas fa-edit"></i>
                </div>
            </div>
